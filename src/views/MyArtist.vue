<template>
    <div class="bg">
        <div class="ma_main">
            ...
            <div class="ma_body">
                <ul>
                    <li v-for="item in $parent.collectArtist" class="clear-fix">
                        <div class="cvr">
<!--                            <a href=""><img :src="item.picUrl" alt="" class="singerimg"></a>-->
                            <router-link :to="{path:'/artists',query:{id:item.id}}"><img :src="item.picUrl" alt="" class="singerimg"></router-link>
                        </div>
                        <div class="detail">
                            <h3>
<!--                                <a href=""></a>-->
...
<style scoped>
@import '../assets/css/myartist.css';
</style>